#!/bin/bash
#SBATCH --job-name=training_clip_b32
#SBATCH -p gpupart
#SBATCH -A staff
#SBATCH -t 24:00:00
#SBATCH --gres gpu:1
...
#SBATCH --output=/nfs/data_todi/jli/Alessio_works/MDIN-clone/training_clip_b32.out
#SBATCH --error=/nfs/data_todi/jli/Alessio_works/MDIN-clone/training_clip_b32.err
#SBATCH --ntasks=1
